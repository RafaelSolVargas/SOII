...
struct Type
{
    static const Type_Id ID = UNKNOWN_TYPE_ID;
};

template <>
struct Type<CPU>
{
    static const Type_Id ID = CPU_ID;
};
template <>
struct Type<TSC>
{
    static const Type_Id ID = TSC_ID;
};
template <>
struct Type<MMU>
{
    static const Type_Id ID = MMU_ID;
};
template <>
struct Type<FPU>
{
    static const Type_Id ID = FPU_ID;
};
template <>
struct Type<PMU>
{
    static const Type_Id ID = PMU_ID;
};

template <>
struct Type<Machine>
{
    static const Type_Id ID = MACHINE_ID;
};
template <>
struct Type<IC>
{
    static const Type_Id ID = IC_ID;
};
template <>
struct Type<Timer>
{
    static const Type_Id ID = TIMER_ID;
};
template <>
struct Type<UART>
{
    static const Type_Id ID = UART_ID;
};
template <>
struct Type<RTC>
{
    static const Type_Id ID = RTC_ID;
};
template <>
struct Type<PCI>
{
    static const Type_Id ID = PCI_ID;
};
template <>
struct Type<Display>
{
    static const Type_Id ID = DISPLAY_ID;
};
template <>
struct Type<Keyboard>
{
    static const Type_Id ID = KEYBOARD_ID;
};
template <>
struct Type<Scratchpad>
{
    static const Type_Id ID = SCRATCHPAD_ID;
};
template <>
struct Type<Ethernet>
{
    static const Type_Id ID = NIC_ID;
};
template <>
struct Type<IEEE802_15_4>
{
    static const Type_Id ID = NIC_ID;
};
...
struct Type<Thread>
{
    static const Type_Id ID = THREAD_ID;
};
template <>
struct Type<Periodic_Thread>
{
    static const Type_Id ID = THREAD_ID;
};
template <>
struct Type<RT_Thread>
{
    static const Type_Id ID = THREAD_ID;
};
template <>
struct Type<Active>
{
    static const Type_Id ID = ACTIVE_ID;
};
template <>
struct Type<Task>
{
    static const Type_Id ID = TASK_ID;
};

template <>
struct Type<Address_Space>
{
    static const Type_Id ID = ADDRESS_SPACE_ID;
};
template <>
struct Type<Segment>
{
    static const Type_Id ID = SEGMENT_ID;
};

template <>
struct Type<Mutex>
{
    static const Type_Id ID = MUTEX_ID;
};
template <>
struct Type<Semaphore>
{
    static const Type_Id ID = SEMAPHORE_ID;
};
template <>
struct Type<Condition>
{
    static const Type_Id ID = CONDITION_ID;
};

template <>
struct Type<Clock>
{
    static const Type_Id ID = CLOCK_ID;
};
template <>
struct Type<Chronometer>
{
    static const Type_Id ID = CHRONOMETER_ID;
};
template <>
struct Type<Alarm>
{
    static const Type_Id ID = ALARM_ID;
};
template <>
struct Type<Delay>
{
...
struct Type<Utility>
{
    static const Type_Id ID = UTILITY_ID;
};
